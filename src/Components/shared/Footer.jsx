...
// Gravity UI Icons for social media and button actions
import { LogoTwitter, LogoYoutube, LogoFacebook, ArrowRight } from '@gravity-ui/icons';

const Footer = () => {
  return (
    <footer className="w-full border-t border-neutral-900 bg-[#0a0a0a] text-neutral-400">
      <div className="mx-auto max-w-8xl px-6 py-12">
        ...
        <div className="grid grid-cols-1 gap-15 md:grid-cols-2 lg:grid-cols-4 justify-between items-center">
          ...
          <div className="flex flex-col gap-4  items-center sm:items-start text-center sm:text-left">
            <FooterLogo />
            <div>
              <p className="font-serif text-base font-bold text-neutral-200">
                Online Lawyer Hiring Platform
              </p>
              <p className="font-mono text-xs tracking-wider text-orange-400 mt-1">
          ...
          <div className="flex flex-col gap-3 items-center sm:items-start w-full">
            <span className="font-mono text-xs font-bold uppercase tracking-widest text-neutral-300 text-center sm:text-left">
              Stay Updated
            </span>
            <p className="text-xs text-neutral-500 text-center sm:text-left max-w-xs">
              Subscribe to our brief newsletter to get legal insights and platform updates.
            </p>
            {/* Frontend-only dynamic form submission */}
            <form 
              onSubmit={(e) => e.preventDefault()} 
              className="flex w-full max-w-sm items-center gap-2 rounded-xl border border-neutral-800 bg-[#121212] p-1"
            >
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full bg-transparent px-3 py-2 text-xs text-neutral-200 outline-none placeholder:text-neutral-600"
                required
              />
              <button
                type="submit"
          ...
          <div className="flex flex-col gap-4 items-center sm:items-start text-center sm:text-left">
            ...
            <div className="flex gap-4">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-neutral-800 bg-[#121212] text-neutral-400 transition-all hover:border-neutral-700 hover:text-orange-400"
              >
               <svg
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center text-xs font-mono text-neutral-600">
          <p>
